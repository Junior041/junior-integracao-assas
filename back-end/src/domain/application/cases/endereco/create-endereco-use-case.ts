...
export class CreateEnderecoUseCase {
  constructor(private readonly enderecoRepository: EnderecoRepository, private readonly pessoaRepository: PessoaRepository) {}
  async execute(data: CreateEnderecoUseCaseRequest): Promise<CreateEnderecoUseCaseResponse> {
